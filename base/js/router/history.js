...
$require('history', ['extend', 'singleton', 'utils', 'location'], function(extend, singleton, utils, Location) {
  ...
  History.prototype.init = function() {
    ...
    this._hasHashChange = window ? 'onhashchange' in window : false;
  ...
  History.prototype._onLinkClick = function(e) {
    ...
    var routes = this._getRoutes(fragment);
    if (!routes) return;
    // Navigate to the link.
    this.navigate(fragment);
    // Load the routes.
    this._executeRoutes(routes, this.getFragment(fragment));
    e.preventDefault();
  ...
  History.prototype.loadUrl = function(fragment) {
    ...
    return this._executeRoutes(routes, this.getFragment(fragment));
  };

  History.prototype._getRoutes = function(fragment) {
  ...
  History.prototype._executeRoutes = function(routes, fragment) {
