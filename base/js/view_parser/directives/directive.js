...
$require(__className, ['extend', 'scopeTree', 'view'], function(extend, scopeTree, View) {
  ...
  Directive.prototype.__beforeInit = function(attrs, el, scopeTreeObj, isolateScope) {
    // Make sure a scopeTree is passed in.
    scopeTreeObj = scopeTreeObj || scopeTree.create(this);
    ...
    this._super(attrs, el, scopeTreeObj, isolateScope);
