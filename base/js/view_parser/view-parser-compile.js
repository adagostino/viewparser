  ...
  ViewParser.prototype._compileMVC = function(attr, domTree, attrs) {
    ...
    switch(type) {
      case 'directive':
        ...
        view = new mvcObj[type](attrObj, domTree.el, domTree.scopeTree, mvcObj.$scope);
        break;
      case 'controller':
        view = new mvcObj[type](attrObj, domTree.el, domTree.scopeTree);
        break;
      case 'app':
        view = new mvcObj[type](attrObj, domTree.el, domTree.scopeTree, mvcObj.router);
        break;
      default:
        break;
    }
    var viewDomTree = this.getDomTreeFromElement(view.el);
